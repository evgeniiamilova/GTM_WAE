...
from GTM_WAE.layers import DecoderGRU, EncoderAttention, PositionalEncoding
from GTM_WAE.metrics import recrate, kl_gaussianprior, wae_mmd_gaussianprior, kl_gaussian_sharedmu
...
class GTM_WAE(LightningModule):
    ...
    def sample_from_node(self, loc, scale=float):  # Sampling from the node
        """
        Sample z ~ p(z) = N(0, I)
        """
